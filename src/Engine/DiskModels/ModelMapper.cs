	...
	static internal class ModelMapper
	{
		...
		static private (Type type, Delegate factory)[] GetModelProcessingMappings(GameServiceContainer gameServices)
		{
			...
			[
                ...
                (typeof(TextLineModel), graphicTextService.GetTextLineFromModel),
                (typeof(SimpleTextModel), graphicTextService.GetGraphicTextFromModel<SimpleText>),
				(typeof(WritableTextModel), graphicTextService.GetGraphicTextFromModel<WritableText>),
