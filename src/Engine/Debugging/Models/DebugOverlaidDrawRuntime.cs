...
{
	/// <summary>
	/// Represents a debug overlaid draw runtime.
	/// </summary>
	public class DebugOverlaidDrawRuntime : IAmDrawable
	{
		/// <summary>
		...
		/// <summary>
		/// Initializes a new instance of the debug overlaid draw runtime.
		/// </summary>
		public DebugOverlaidDrawRuntime()
		{
