...
namespace BaseContent.BaseContentConstants.Images
{
	...
	static public class PalletColorToTextureBoxHelper
	{
		...
		static private Dictionary<Color, Rectangle> PalletColorTextureBoxMap { get; } = new()
		{
			...
			{ PalletColors.Hex_424C6E, new Rectangle(10, 0, 1, 1) },
			...
			{ PalletColors.Hex_F6CA9F, new Rectangle(20, 0, 1, 1) },
			...
			{ PalletColors.Hex_0098DC, new Rectangle(40, 0, 1, 1) },
			...
			{ PalletColors.Hex_03193F, new Rectangle(50, 0, 1, 1) },
			...
			{ PalletColors.Hex_891E2B, new Rectangle(60, 0, 1, 1) },
