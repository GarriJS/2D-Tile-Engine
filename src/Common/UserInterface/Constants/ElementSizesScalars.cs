...
namespace Common.UserInterface.Constants
{
    ...
    static public class ElementSizesScalars
    {
        ...
        /// </summary>
        static public Vector2 Small { get; } = new Vector2(1f / 4f, 1f / 5f);

        /// <summary>
        /// The medium element size scalars.
        /// </summary>
        static public Vector2 Medium { get; } = new Vector2(1f / 3f, 1f / 4f);

        /// <summary>
        /// The large element size scalars.
        /// </summary>
        static public Vector2 Large { get; } = new Vector2(1f / 2f, 1f / 3f);

        /// <summary>
        /// The extra large element size scalars.
        /// </summary>
        static public Vector2 ExtraLarge { get; } = new Vector2(1f, 1f / 2f);

        /// <summary>
        /// The full element size scalars.
        /// </summary>
        static public Vector2 Full { get; } = new Vector2(1, 1);
    }
}
